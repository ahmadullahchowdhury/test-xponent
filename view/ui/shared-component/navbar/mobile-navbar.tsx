  ...
  return (
    <>
      <div className='block xl:hidden'>
        <div
          className={`fixed z-50 flex   h-full w-9/12 max-w-full flex-col gap-2 overflow-y-auto bg-primary duration-500 ease-in md:gap-0 ${isMenuOpen ? 'right-0 top-0' : '-right-full top-0'
            }`}
        >
          <div className='bg-base-100  relative m-1.5 mt-2 flex flex-col rounded-xl bg-primary p-6 text-lg font-normal leading-6'>
              ...
              >
                <span className='flex items-center gap-2'>
                  <Image
                    ...
                    priority
                  />
                </span><span className='text-black pt-1 font-bold text-[18px] '></span>
              </Link>
              <button
                            ...
                            >
                              <Disclosure.Panel className=''>
                                {lt?.subMenu?.map((item, index) => (
                                  <p key={index} className='  px-2.5 py-1.5 text-lg capitalize text-gray-700 '>
                                    <Link
                                      href={item.link}
                                      className=' '
                                      style={{
